...
const mockEvents = {
    events: [
        { title: 'Event 1: Tea Party', id: 1, description: 'Enjoy a cup of tea with wonderful ladies.' },
        { title: 'Event 2: Knitting Knacks', id: 2, description: 'This month we are knitting a sweater' }
    ]
};
